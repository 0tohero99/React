...
class Header extends Component {
    ...
    constructor() {
        ...
        // super is required  to access the properties from the parent class whenever constructor is used.//
        super()
        this.state = {
            title: "React",
    ...
    render() {
        ...
        return (
            ...
            <header style={style.header} >
                ...
                <input placeholder= {this.state.search} onChange={this.handleChange} style={style.input} />
